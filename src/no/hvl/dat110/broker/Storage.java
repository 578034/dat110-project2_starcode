...
public class Storage {
	...
	// hold på meldinger om den brukeren er frakobla
	// mapper fra en bruker til et sett av meldinger
	// evt fra en ClientSession?
	...
	//task E
	//hent lagret meldinger på en bruker (og slett de fra mappen)
	...
	//task E
	//lagerer en melding på en frakobla bruker
